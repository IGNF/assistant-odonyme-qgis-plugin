...
SOURCES = \
	__init__.py \
	RenommeRue.py RenommeRue_dialog.py

PLUGINNAME = RenommeRue

PY_FILES = \
	__init__.py \
	RenommeRue.py RenommeRue_dialog.py

UI_FILES = RenommeRue_dialog_base.ui
...
QGISDIR=C:\Users\gpecheur\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
